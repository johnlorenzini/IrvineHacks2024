...
function Prognosis() {
  ...
  return (
    <div className="col-span-7 row-span-1">
      <Button
        className="shadow-md flex-col size-full bg-cover h-full rounded-2xl border-2 border-[#F23030] bg-[#FEF3F3] p-[20px] justify-start items-start flex text-black"
        style={{
          borderColor: activePalette.accent,
          backgroundColor: activePalette.card,
        }}
...
function Research() {
  ...
  return (
    <div className="col-span-5 row-span-2">
      <Button
        className=" rounded-xl border-2 border-slate-400/10 size-full bg-neutral-100 p-4 dark:bg-neutral-900 justify-start items-start flex text-black"
        style={{
          borderColor: activePalette.accent,
          backgroundColor: activePalette.card,
        }}
